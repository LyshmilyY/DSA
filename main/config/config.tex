...
% 封面设置
\title{\LaTeX\quad \quad \textbf{\textit{Data Structure \& Algorithms}}} % 标题
\subtitle{{\fontspec{Times New Roman}\textit{Something useless that serves no practical purpose}}} % 副标题
